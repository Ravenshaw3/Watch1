#!/bin/bash
# Quick Build Fix for Watch1 v3.0.3

if [[ -z "${ALLOW_V303_SCRIPTS:-}" ]]; then
  echo "[Watch1] Deprecated script detected (quick-build-fix-v303.sh)." >&2
  echo "[Watch1] This automation targets v3.0.3 and will not run against v3.0.4." >&2
  echo "[Watch1] Set ALLOW_V303_SCRIPTS=1 to override explicitly." >&2
  exit 1
fi

echo "🚀 QUICK BUILD FIX FOR WATCH1 v3.0.3"
echo "========================"
